...
export function Hero() {
  return (
    <section className="relative pt-[200px] pb-24 md:pt-[260px] md:pb-32 flex items-center justify-center bg-background">
      <div className="container relative z-10 px-6 text-center max-w-3xl mx-auto pt-12">
        <motion.div
